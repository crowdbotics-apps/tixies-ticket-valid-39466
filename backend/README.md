...
## Project Structure
    ...
    ├── tixies_ticket_valid_39466  # Django project configurations
...
1. Clone this repo and `cd tixies_ticket_valid_39466`
...
2. Clone this repo and `cd tixies_ticket_valid_39466`
